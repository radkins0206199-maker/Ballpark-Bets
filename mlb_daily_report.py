...
def retrain_model_if_needed():
    ...
    try:
        ...
        # Phase 4.5: elo_diff added — Elo was computed/stored/displayed since
        # June 4 but never reached the model. It is the single strongest
        # team-strength signal available and encodes recent form better than
        # season win%, so it goes in alongside the (now actually populated)
