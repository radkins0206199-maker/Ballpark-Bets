...
def _sync_results_supabase(df):
    ...
    sb_key = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndreHBkbWZhYmllcGtmZHhiZGllIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg3ODg0NTQsImV4cCI6MjA5NDM2NDQ1NH0.t6IBHRqgh-PMKU8Aeaij0a6fyq_N7dKEU_5bSh7TIHc")
